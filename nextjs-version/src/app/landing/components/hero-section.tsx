        ...
        <div className="mx-auto max-w-4xl text-center">
          ...
          <div className="mb-8 flex justify-center">
            <Badge variant="outline" className="px-4 py-2 border-foreground">
              <Star className="w-3 h-3 mr-2 fill-current text-amber-400" />
              New: Instant Free VPS Deployment Live
          ...
          <p className="mx-auto mb-10 max-w-2xl text-lg text-muted-foreground sm:text-xl">
            Experience lightning-fast NVMe storage, full root access, dedicated IPv4/IPv6, and 99.9% uptime.
            Launch your free VPS with InterENL in less than 60 seconds.
          </p>
