      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground">
            Our engineering team is here to help you deploy, configure, and scale your free InterENL cloud VPS. Choose the best way to reach out.
          </p>
        </div>
          ...
          <div className="space-y-6 order-2 lg:order-1">
            ...
            <Card className="hover:shadow-md transition-shadow cursor-pointer">
              ...
              <CardContent>
                ...
                <Button variant="outline" size="sm" className="cursor-pointer" asChild>
                  <a href="https://github.com/xrosierose/interdash/issues" target="_blank" rel="noopener noreferrer">
                    View on GitHub
                  </a>
                </Button>
              </CardContent>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Textarea
                              placeholder="Tell us how we can help you with your InterENL cloud VPS deployment or server setup..."
                              rows={10}
                              className="min-h-50"
                              {...field}
                            />
