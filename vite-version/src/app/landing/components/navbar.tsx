...
const solutionsItems = [
  ...
  { name: 'Free KVM VPS', href: '/dashboard' },
  { name: 'Dedicated Compute', href: '#features' },
  { name: 'NVMe Storage', href: '#features' },
  { name: 'Global Network', href: '/dashboard-2' },
  { title: 'Linux Distributions' },
  { name: 'Ubuntu 24.04 LTS', href: '/dashboard' },
  { name: 'Debian 12 Bookworm', href: '/dashboard' },
  { name: 'Alpine Linux 3.20', href: '/dashboard' },
  { name: 'Arch & Fedora', href: '/dashboard' },
  { title: 'Developer Platform' },
  { name: 'Web SSH Terminal', href: '/dashboard' },
  { name: 'Real-Time Telemetry', href: '/dashboard-2' },
  { name: '1-Click Provisioning', href: '/dashboard' },
  { name: 'GitHub Repository', href: 'https://github.com/xrosierose/interdash' }
]
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 flex h-16 items-center justify-between">
        ...
        <div className="hidden xl:flex items-center space-x-2">
          ...
          <Button variant="ghost" size="icon" asChild className="cursor-pointer">
            <a href="https://github.com/xrosierose/interdash" target="_blank" rel="noopener noreferrer" aria-label="GitHub Repository">
