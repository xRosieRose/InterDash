...
const socialLinks = [
  ...
  { name: 'GitHub', href: 'https://github.com/xrosierose/interdash', icon: Github },
          ...
          <div className="col-span-4 lg:col-span-2 max-w-2xl">
            <div className="flex items-center space-x-2 mb-4 max-lg:justify-center">
              <a href="#hero" className="flex items-center space-x-2 cursor-pointer">
                <Logo size={32} />
                <span className="font-bold text-xl">{settings.brand_name || "InterDash"}</span>
              </a>
            </div>
            <p className="text-muted-foreground mb-6 max-lg:text-center max-lg:flex max-lg:justify-center">
              The hosting of your dreams, your own free VPS. Deploy blazing-fast, secure cloud servers and compute instances in seconds.
            </p>
        ...
        <div className="flex flex-col lg:flex-row justify-between items-center gap-2">
          <div className="flex flex-col sm:flex-row items-center gap-2 text-muted-foreground text-sm">
            <div className="flex items-center gap-1.5">
              <span>Made With</span>
              <Heart className="h-4 w-4 text-red-500 fill-current" aria-label="<3" />
              <span>by</span>
